...
export default function BlockedUsersScreen() {
  ...
  const { refreshing: blockedPullRefreshing, onRefresh: onBlockedPullRefresh } = usePullToRefresh(async () => {
    /* list not wired yet */
  });
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.screenBg }} edges={['top']}>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl
            refreshing={blockedPullRefreshing}
            onRefresh={onBlockedPullRefresh}
