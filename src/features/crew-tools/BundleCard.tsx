...
const styles = StyleSheet.create({
  ...
  kicker: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  kickerText: { fontSize: 9, fontWeight: '800', letterSpacing: 0.35 },
  price: { fontSize: 12, fontWeight: '700', color: colors.textSecondary },
  title: { fontSize: 18, fontWeight: '800', color: colors.textPrimary, lineHeight: 24 },
  blurb: { fontSize: 14, color: colors.textSecondary, marginTop: 8, lineHeight: 20 },
